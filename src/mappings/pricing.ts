...
const WHT_HUSD_PAIR = '0x71bfb0b0c730c267d4c2aa6b50a07c1d13c21850' // created block 1587531

export function getEthPriceInUSD(): BigDecimal {
  // fetch eth prices for each stablecoin
  // let daiPair = Pair.load(DAI_WHTPAIR) // dai is token0, disabled for no big liquidity
